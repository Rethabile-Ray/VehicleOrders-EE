<%-- 
    Document   : view_critically_delayed
    Created on : 04 Jun 2026, 20:33:36
    Author     : mokau
--%>
...
<html>
    ...
    <body>
        <h1>Critically Delayed Orders View</h1>
        <table border="1">
            <th>No.</th>
            <th>Order Ref</th>
            <th>Name</th>
            ...
            <%
               ...
               List<OrderEntity> orders = (List<OrderEntity>)request.getAttribute("delayedOrders");
